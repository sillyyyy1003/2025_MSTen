...
namespace GameData
{
    ...
    /// 瘋狂科學家教の宣教師データ
    /// </summary>
    [CreateAssetMenu(fileName = "MadScientistReligionMissionaryData", menuName = "GameData/Religions/MadScientistReligion/MissionaryData")]
    public class MadScientistReligionMissionaryDataSO : MissionaryDataSO
    {
        private void Reset()
        {
            pieceName = "瘋狂科學家教_宣教師";
            canAttack = true;
            ...
            convertEnemyUpgradeCost = new int[3] { 5, 6, 7 }; // 魅惑傳教士: 無→0.5(5資源), 0.5→0.55(6資源), 0.55→0.65(7資源)
    ...
    public class MadScientistReligionBuildingDataSO : BuildingDataSO
    {
        private void Reset()
        {
            ...
            buildCostUpgradeCost = new int[2] { 6, 8 }; // 建造花費: 9→6, 6→3
