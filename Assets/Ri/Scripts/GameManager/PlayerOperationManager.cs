...
public class PlayerOperationManager : MonoBehaviour
{
    ...
    private bool IsPointerOverUIElement()
    {
        ...
        foreach (var result in results)
        {
            ...
            {
                // 调试日志（可选）
                //Debug.Log($"鼠标在UI上: {result.gameObject.name}");
                return true;
            }
        }
    ...
    {
        Debug.Log("empty cell id is "+SelectedEmptyCellID);
        // 检查是否选中了空格子
