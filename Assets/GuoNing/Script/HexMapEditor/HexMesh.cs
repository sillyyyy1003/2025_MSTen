...
{
	Mesh hexMesh;			// Mesh Render
	static List<Vector3> vertices = new List<Vector3>();    // Triangle vertices
	static List<int> triangles = new List<int>();			// Triangle index
	static List<Color> colors = new List<Color>();
	MeshCollider meshCollider;  // mesh collider for click 
	...
	/// <summary>
	/// Triangulate cell with hex direction
	/// </summary>
	...
	/// <summary>
	/// create an AddTriangle alternative which does not perturb the vertices at all
	/// </summary>
	/// <param name="v1"></param>
	/// <param name="v2"></param>
	/// <param name="v3"></param>
